...
<head>
    ...
    <title>Đăng ký - SPNC Edutech</title>
                ...
                <div class="card login-card">
                    <div class="card-body p-4 p-md-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted small">Tham gia cộng đồng học tập SPNC Edu</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-4">
                                <label class="form-label text-muted small fw-bold">Nhập lại mật khẩu</label>
                                <div class="input-group">
                            ...
                            <div class="d-grid mb-3">
                                <button type="submit" class="btn btn-primary-custom text-white shadow">Đăng Ký</button>
                            </div>

                            <div class="text-center">
                                <span class="text-muted small">Đã có tài khoản?</span>
                                <a href="{{ route('login') }}" class="fw-bold text-decoration-none text-primary ms-1">Đăng nhập</a>
                            </div>
                        </form>
                    </div>
                </div>
